...
const investigativeMeasures: Record<string, string> = {
  ...
  'IM032': 'analyze NetFlow/PCAP/Zeek for C2, exfiltration, or lateral movement',
...
const measures: Record<string, string> = {
    ...
    'M003': 'deactivate compromised accounts', //WICHTIG
    ...
    'M012': 'quarantine / delete affected emails',
    'M013': 'disable task(s)',
    ...
    'M020': 'if relevant: Replace compromised component with verified clean version', //nur durch Logik ins Mapping
...
// Mapping von Taktik → Maßnahmen (füge deine vollständige Map hier ein)
const tacticToActionMap: Record<string, string[]> = {

//REVIEWED 
'WannaCry': ['IM012','M017','M001','M041','M029','IM003','M007','M024','IM033','IM032','IM020','IM021','IM014','IM011','IM007','IM041','M020','M005'],
'Lockbit': ['IM012','M001','IM017','M029','IM003','M007','M017','M024','IM033','IM032','IM020','PFM042','IM021','IM014','IM011','IM007','IM022','IM035','IM041','M037','M005'],
'Conti': ['IM012','M001','M041','M029','IM003','M007','M017','M024','IM033','IM032','IM020','PFM042','IM021','IM014','IM011','IM007','IM022','IM017','IM041','M022','M005'],
'Supply Chain': ['IM012','M017','IM017','IM029','M001','M002','M041','M026','M037','M028','BFM016','PFM019','BFM020','PFM044','M029','IM021','IM033','IM032','IM040','IM007','M007','M008','M006','M012','IM041','M005','M044'],
...
'Credential Harvesting': ['IM012','M017','M001','M024','M004','M026','M005','IM033','IM022','IM029','PFM019'],
'Drive-by Download': ['IM012','M017','M001','M024','IM003','IM021','PFM019'],
'Formjacking': ['IM012','M017','M001','BFM024','IM021','IM029','IM032','PFM019'],
'Watering Hole': ['IM012','M017','M001','M024','IM032','IM029','IM021','PFM019'],
'Zero Day': ['IM012','M017','M001','M024','M020','IM033','IM021','IM029','PFM019'],
'Fileless Malware': ['IM012','M017','M001','M024','M015','IM033','IM029','PFM019'],
'LOLBins': ['IM012','M017','M001','M024','M015','IM033','IM029','PFM019'],
'Webshell': ['IM012','M017','M001','M024','M005','IM033','IM021','IM029','PFM019'],
'SSRF': ['IM012','M017','M001','M024','M020','IM021','IM032','IM029','PFM019'],
'XXE': ['IM012','M017','IM021','IM029','M001','PFM019','M024','M020'],
'Deserialization': ['IM012','M017','IM021','IM029','IM032','M001','PFM019','M024','M020'],
'SSO/OAuth Abuse': ['IM012','M017','IM022','IM029','IM040','M001','M024','M026','M028'],
'Cloud Misconfig': ['IM012','M017','IM040','IM029','IM033','M001','M024','M020'],
'Dependency Confusion': ['IM012','M017','IM029','IM033','IM040','M001','M026','M024','M025'],
'SIM Swap': ['IM012','M017','IM001','IM022','IM029','M001','M024','M028','M026'],
'Cryptojacking': ['IM012','M017','IM033','IM032','IM029','M001','PFM019','M024','M015','M025'],
'Sidechannel': ['IM012','M017','IM033','IM029','IM021','M001','PFM019','M024'],
'API Abuse': ['IM012','M017','IM040','IM029','IM032','M001','M024','M026'],
'Web API Injection': ['IM012','M017','IM021','IM029','IM032','M001','PFM019','M024','M020'],
'Container Escape': ['IM012','M017','M001','M024','M020','IM033','IM029','IM021','PFM019'],
'Firmware Attack': ['IM012','M017','M001','M024','M005','IM033','IM029','IM031','PFM019'],
['M001','M018','IM017','IM034','IM033','IM021','IM012','IM014','IM038','IM040','IM008','IM029','IM030','BFM016','BFM019','BFM020','BFM026','BFM028','BFM037','M016','M024','M047','M017','M044','M021'],
'T1195.001': ['M001','M018','IM017','IM034','IM033','IM021','IM012','IM014','IM040','IM008','IM029','IM030','BFM016','BFM019','BFM020','BFM026','BFM028','BFM037','M016','M024','M047','M017','M044','M021'],
'T1195.002': ['M001','M018','IM017','IM034','IM033','IM021','IM012','IM014','IM038','IM040','IM008','IM029','IM030','BFM016','BFM019','BFM020','BFM026','BFM028','BFM037','M016','M024','M047','M017','M044','M021'],
'T1195.003': ['M001','M018','IM017','IM034','IM033','IM021','IM012','IM014','IM040','IM008','IM029','IM030','BFM016','BFM019','BFM020','BFM026','BFM028','BFM037','M016','M024','M047','M017','M044','M021'],

//REVIEWED
'T1204':     ['IM004','IM012','IM017','IM029','IM003','IM021','IM014','IM008','IM033','IM032','IM025','M008','M019','M007','M012','M004','M018','M044'],
'T1204.001': ['IM004','IM012','IM017','IM029','IM003','IM021','IM014','IM008','M008','M019','M007','M012','M004','M018','M044'],
'T1204.002': ['M001','BFM016','PFM019','M029','IM003','IM021','IM033','IM032','IM025','BFM028','M007','M004','M018','PFM044','M005'],
'T1204.003': ['IM004','IM012','IM017','IM029','IM003','IM021','IM014','IM008','IM033','IM032','IM025','BFM028','M007','M004','M018','PFM019','PFM044','M005'],
'T1204.004': ['IM004','IM012','IM017','IM029','IM003','IM021','IM014','IM008','IM033','IM032','IM025','IM028','BFM028','M007','M004','M018','PFM019','PFM044','M005'],
...
'T1213.001': ['M001','M018','IM022','IM040','IM034','IM033','IM021','IM014','IM012','IM008','IM029','IM030','BFM016','BFM019','BFM024','M017','M024','M047','M044','M021'], // Confluence → API/Macro Access Logs
'T1213.002': ['M001','M018','IM022','IM040','IM034','IM033','IM021','IM014','IM012','IM038','IM008','IM029','IM030','BFM016','BFM019','BFM024','BFM026','M017','M024','M047','M044','M021'], // SharePoint → Office365-SharePoint logs + file previews
'T1213.003': ['M001','M018','IM022','IM040','IM034','IM033','IM021','IM012','IM014','IM029','IM030','IM008','BFM016','BFM019','BFM020','BFM026','PFM019','M017','M024','M047','M044','M021'], // Code Repos → PAT Theft, repo clones, SSH key use
'T1213.004': ['M001','M018','IM022','IM040','IM038','IM034','IM033','IM021','IM008','IM029','IM030','BFM024','BFM016','BFM019','M017','M024','M047','M044','M021'], // OneNote → local+cloud cache analysis
'T1213.005': ['M003','M018','M028','IM022','IM040','IM034','IM033','IM021','IM029','IM030','IM008','BFM016','BFM019','M017','M024','M047','M044','M021'], // Internal Defenses → HIGH RISK → Identity reset Pflicht

'T1216': ['M001','M018','IM017','IM034','IM033','IM021','IM012','IM029','IM030','IM008','BFM016','BFM019','BFM026','BFM028','BFM037','M024','M047','M044','M021'],
'T1216.001': ['M001','M018','IM017','IM034','IM033','IM021','IM012','IM029','IM030','IM008','BFM016','BFM019','BFM026','BFM028','BFM037','M024','M047','M044','M021'], // PubPrn → VBS execution chain
'T1216.002': ['M001','M018','IM017','IM034','IM033','IM021','IM040','IM012','IM029','IM030','IM008','BFM016','BFM019','BFM026','BFM028','BFM037','M024','M047','M044','M021'], // SyncAppvPublishingServer → Cloud/Enterprise logs
...
'T1218.001': ['M001','M018','IM017','IM034','IM033','IM012','IM021','IM029','IM030','IM008','BFM016','BFM019','BFM026','BFM028','BFM037','M024','M047','M044','M021'], // Compiled HTML (hh.exe)
'T1218.002': ['M001','M018','IM017','IM034','IM033','IM012','IM021','IM029','IM030','IM008','BFM016','BFM019','BFM026','BFM028','M024','M047','M044','M021'], // CPL execution
'T1218.003': ['M001','M018','IM017','IM034','IM033','IM012','IM014','IM021','IM029','IM030','IM008','BFM016','BFM019','BFM026','BFM028','BFM037','M024','M047','M044','M021'], // CMSTP → net/proxy loading
'T1218.004': ['M001','M018','IM017','IM034','IM033','IM012','IM021','IM029','IM030','IM008','BFM016','BFM019','BFM020','BFM026','BFM028','BFM037','M024','M047','M044','M021'], // InstallUtil → Managed code execution
'T1218.005': ['M001','M018','IM017','IM034','IM033','IM012','IM021','IM029','IM030','IM008','BFM016','BFM019','BFM026','BFM028','PFM019','PFM010','PFM044','M024','M047','M044','M021'], // mshta → HTML/JS remote payload
'T1218.007': ['M001','M018','IM017','IM034','IM033','IM012','IM021','IM029','IM030','IM008','BFM016','BFM019','BFM026','BFM028','M024','M047','M044','M021'], // Regsvcs/Regasm → COM registration
'T1218.008': ['M001','M018','IM017','IM034','IM033','IM012','IM021','IM029','IM030','IM008','BFM016','BFM019','BFM026','BFM028','M024','M047','M044','M021'], // odbcconf → config-based execution
'T1218.009': ['M001','M018','IM017','IM034','IM033','IM012','IM021','IM029','IM030','IM008','BFM016','BFM019','BFM026','BFM028','M024','M047','M044','M021'], // Regasm duplicate path (older ATT&CK)
'T1218.010': ['M001','M018','IM017','IM034','IM033','IM012','IM021','IM029','IM030','IM008','BFM016','BFM019','BFM020','BFM026','BFM028','BFM037','M024','M047','M044','M021'], // Regsvr32 → Squiblydoo (remote COM scripting)
'T1218.011': ['M001','M018','IM017','IM034','IM033','IM012','IM021','IM029','IM030','IM008','BFM016','BFM019','BFM020','BFM026','BFM028','PFM019','PFM010','PFM044','M024','M047','M044','M021'], // Rundll32 → DLL-based proxy execution
'T1218.012': ['M001','M018','IM017','IM034','IM033','IM012','IM021','IM029','IM030','IM008','BFM016','BFM019','BFM026','BFM028','M024','M047','M044','M021'], // Verclsid → COM verification abuse
'T1218.013': ['M001','M018','IM017','IM034','IM033','IM021','IM012','IM029','IM030','IM008','BFM016','BFM019','BFM020','BFM026','BFM028','PFM019','PFM010','PFM044','M024','M047','M044','M021'], // Mavinject → Code injection via AppContainers
'T1218.014': ['M001','M018','IM017','IM034','IM033','IM021','IM012','IM029','IM030','IM008','BFM016','BFM019','BFM020','BFM026','BFM028','M024','M047','M044','M021'], // MMC → COM snap-in abuse
'T1218.015': ['M001','M018','IM017','IM034','IM033','IM021','IM012','IM029','IM030','IM008','BFM016','BFM019','BFM026','BFM028','M024','M047','M044','M021'], // PresentationHost → XAML execution
...
'T1219.001': ['M001','M018','IM017','IM038','IM034','IM033','IM021','IM014','IM012','IM008','IM029','IM030','BFM016','BFM019','BFM024','BFM026','BFM028','M016','M019','M024','M047','M017','M044','M021'], // internal spearphishing → email forensics
'T1219.002': ['M001','M018','IM017','IM034','IM033','IM021','IM014','IM012','IM008','IM029','IM030','BFM016','BFM019','BFM020','BFM026','BFM028','M016','M019','M024','M047','M017','M044','M021'], // TeamViewer, AnyDesk, RDP-over-app etc.
'T1219.003': ['M003','M018','M028','IM022','IM040','IM017','IM034','IM033','IM021','IM014','IM012','IM008','IM029','IM030','BFM016','BFM019','M016','M019','M024','M047','M017','M044','M021'], // cloud remote access → identity compromise probable
...
'T1222.001': ['M001','M018','IM017','IM034','IM033','IM021','IM012','IM008','IM029','IM030','BFM016','BFM019','BFM026','BFM028','BFM037','M025','M024','M047','M044','M021'], // Windows ACL/permissions
'T1222.002': ['M001','M018','IM017','IM034','IM033','IM021','IM032','IM008','IM029','IM030','BFM016','BFM019','BFM020','BFM026','M025','M024','M047','M044','M021'], // Linux/mac chmod/chown privilege enhancement
...
'T1480.001': ['M001','M018','IM017','IM034','IM033','IM022','IM040','IM021','IM012','IM008','IM029','IM030','BFM016','BFM019','BFM028','PFM019','PFM010','PFM044','M024','M047','M044','M021'], // environment keying → identity relevance
'T1480.002': ['M001','M018','IM017','IM034','IM033','IM021','IM012','I
'T1550.003': ['IM001','M003','M018','M028','M004','IM022','BFM016','BFM019','IM034','IM033','IM021','IM029','IM030','IM013','BFM028','PFM019','PFM010','IM016','IM039','M024','M047','M044','M021'],  // Pass the Ticket (Kerberos)
'T1550.004': ['IM001','M003','M018','M028','M004','IM022','IM040','IM038','BFM016','BFM019','IM034','IM033','IM021','IM029','IM030','IM013','IM016','IM039','M024','M047','M044','M021'],  // Web Session Cookie theft
    
'T1552': ['IM001','M001','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','M024','M047','M044','M021'],
'T1552.001': ['IM001','M001','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','M024','M047','M044','M021'],  // creds in files
'T1552.002': ['IM001','M001','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM026','BFM028','IM016','IM039','M024','M047','M044','M021'],  // registry
'T1552.003': ['IM001','M001','BFM016','BFM019','IM032','IM017','IM034','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','M024','M047','M044','M021'],  // bash history
'T1552.004': ['IM001','M003','M018','M028','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','M024','M047','M044','M021'],  // private keys (SSH/PAT)
'T1552.005': ['IM001','M003','M018','M028','IM022','IM040','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','IM016','IM039','M024','M047','M044','M021'],  // cloud metadata API
'T1552.006': ['IM001','M003','M018','M028','IM022','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM026','IM016','IM039','M024','M047','M044','M021'],  // GPP passwords
'T1552.007': ['IM001','M003','M018','M028','IM022','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','IM016','IM039','M024','M047','M044','M021'],  // reversible encryption
'T1552.008': ['IM001','M003','M018','M028','IM022','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM028','PFM019','PFM010','IM016','IM039','M024','M047','M044','M021'],  // kerberos ticket forgery
...
'T1553.001': ['IM001','M001','BFM016','BFM019','BFM037','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','M025','M024','M047','M044','M021'],  // Gatekeeper bypass (macOS)
'T1553.002': ['IM001','M001','BFM016','BFM019','BFM037','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','M025','M024','M047','M044','M021'],  // Code signing abuse
'T1553.003': ['IM001','M001','BFM016','BFM019','BFM037','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','M025','M024','M047','M044','M021'],  // SIP/trustd bypass
'T1553.004': ['IM001','M001','BFM016','BFM019','BFM037','IM014','IM012','IM029','IM030','IM013','IM016','IM039','M025','M024','M047','M044','M021'],  // Install Root Certificate
'T1553.005': ['IM001','M001','BFM016','BFM019','BFM037','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','M025','M024','M047','M044','M021'],  // MOTW bypass
'T1553.006': ['IM001','M001','BFM016','BFM019','BFM037','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','M025','M024','M047','M044','M021'],  // Code signing policy modification
...
'T1557.001': ['IM001','M001','BFM016','BFM019','IM014','IM012','IM021','IM032','IM029','IM030','IM034','IM033','IM013','BFM025','IM016','IM039','M016','M024','M047','M044','M021'],  // LLMNR/NBT-NS poisoning + SMB relay
'T1557.002': ['IM001','M001','BFM016','BFM019','IM014','IM012','IM021','IM032','BFM009','IM029','IM030','IM034','IM013','BFM025','IM016','IM039','M016','M024','M047','M044','M021'],  // ARP poisoning
'T1557.003': ['IM001','M001','BFM016','BFM019','IM014','IM012','IM021','IM032','IM029','IM030','IM034','IM013','BFM025','IM016','IM039','M016','M024','M047','M044','M021'],  // DHCP spoofing
'T1557.004': ['IM001','M001','BFM016','BFM019','IM014','IM011','IM021','IM032','IM029','IM030','IM034','IM013','BFM025','IM016','IM039','M016','M024','M047','M044','M021'],  // Evil Twin
...
'T1558.001': ['IM001','M003','M018','M028','M004','IM022','BFM016','BFM019','PFM019','PFM010','IM034','IM033','IM021','IM029','IM030','IM013','IM016','IM039','M024','M047','M044','M021'],  // Golden Ticket
'T1558.002': ['IM001','M003','M018','M028','M004','IM022','BFM016','BFM019','IM034','IM033','IM021','IM029','IM030','IM013','BFM028','IM016','IM039','M024','M047','M044','M021'],  // Silver Ticket
'T1558.003': ['IM001','M003','M018','M028','M004','IM022','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','M024','M047','M044','M021'],  // Kerberoasting
'T1558.004': ['IM001','M003','M018','M028','M004','IM022','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','M024','M047','M044','M021'],  // AS-REP roasting
'T1558.005': ['IM001','M003','M018','M028','M004','IM022','BFM016','BFM019','PFM019','PFM010','IM034','IM033','IM021','IM029','IM030','IM013','BFM028','IM016','IM039','M024','M047','M044','M021'],  // TGT abuse / ccache files

'T1559': ['IM001','M001','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','M024','M047','M044','M021'],
'T1559.001': ['IM001','M001','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM026','BFM028','IM016','IM039','M024','M047','M044','M021'],  // COM
'T1559.002': ['IM001','M001','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM026','IM016','IM039','M024','M047','M044','M021'],  // DDE
'T1559.003': ['IM001','M001','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM026','IM016','IM039','M024','M047','M044','M021'],  // WMI

'T1560': ['IM001','M001','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','M024','M047','M044','M021'],
'T1560.001': ['IM001','M001','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','M024','M047','M044','M021'],  // archive via utility (zip/7z)
'T1560.002': ['IM001','M001','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','BFM020','M024','M047','M044','M021'],  // archive via library (.NET compress etc.)
'T1560.003': ['IM001','M001','BFM016','BFM019','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','BFM020','M024','M047','M044','M021'],  // custom archiver
...
'T1561.001': ['IM001','M001','BFM016','BFM019','BFM037','BFM020','IM017','IM034','IM033','IM021','IM029','IM030','IM013','IM041','IM039','M005','M024','M047','M044','M021'],  // disk content wipe
'T1561.002': ['IM001','M001','BFM016','BFM019','BFM037','BFM020','IM017','IM034','IM033','IM021','IM029','IM030','IM013','IM041','IM039','M005','M024','M047','M044','M021'],  // disk structure wipe (MBR/GPT)
...
'T1566': ['IM001','M001','BFM016','BFM019','IM038','IM017','IM034','IM033','IM021','IM029','IM030','IM013','BFM025','IM016','IM039','M012','M024','M047','M044','M021'],
'T1566.001': ['IM001','M001','BFM016','BFM019','IM038','IM017','IM034','IM033','IM021','IM012','IM029','IM030','IM013','BFM025','IM016','IM039','M012','M047','M044','M021'],
'T1566.002': ['IM001','M001','BFM016','BFM019','IM017','IM034','IM033','IM021','IM014','IM012','IM029','IM030','IM013','IM016','IM039','M012','M024','M047','M044','M021'],
'T1566.003': ['IM001','M001','BFM016','BFM019','IM038','IM017','IM034','IM033','IM021','IM040','IM029','IM030','IM013','IM016','IM039','M012','M024','M047','M044','M021'],
'T1566.004': ['IM001','M003','M018','M028','IM022','IM040','BFM016','BFM019','IM038','IM017','IM034','IM033','IM021','IM029','IM030','IM013','IM016','IM039','M012','M024','M047','M044','M021'],
...
// ---------- NEU: Self-healing/Linting für die Konfiguration ----------
/**
 * Stellt sicher, dass Maßnahmen, die nur durch Logik hinzugefügt werden sollen
 * (markiert mit '//nur durch Logik ins Mapping'), nicht manuell in der tacticToActionMap vorhanden sind.
...
// Werte passend zu deinen <option value="...">
const REIMAGE_WITHOUT_PROBLEMS = 'reimage';   // "Reimaging possible without problems"
const REIMAGE_ONLY_EMERGENCY   = 'noreimage'; // "Reimaging only in emergencies"
...
function loadIt(): ItState | null { // bleibt unverändert
...
// ---------- 5) Hydration beim Laden ----------
(function hydrate() {
  // Führe die Bereinigung der Konfigurations-Map aus.
  ...
  // NEU: Forensik-Level basierend auf den geladenen Compliance-Einstellungen setzen.
  setForensicsLevelFromCompliance();

  markInvalidStyles();

  // Falls schon eine Tactic steht, gleich berechnen
  if (tacticInput && tacticInput.value.trim()) {
    updateActionsDisplay(tacticInput.value.trim());
  }
  initAlertTimer(); // Die neue Timer-Funktion hier aufrufen
})();

/**
 * NEU: Bestimmt das erforderliche Forensik-Level basierend auf den Compliance-Einstellungen.
...
function getForensicsLevel(): string {
  ...
  // NEU: Forensikanforderungen hoch: BAIT, BSIG, DORA, EnWG, gematik
  ...
  // NEU: Forensikanforderungen mittel: DSGVO, NIS-2, TKG, B3S, C5
  ...
  // NEU: Niedrig (ISO27001, SOC2, TISAX, IT-Grundschutz) oder keine vorhanden
  // Beide Fälle resultieren in 'noforensics', was BFM und PFM Maßnahmen ausfiltert.
  return 'noforensics';
}

/**
 * NEU: Setzt den Wert des Forensik-Dropdowns basierend auf den Compliance-Einstellungen.
 */
function setForensicsLevelFromCompliance() {
  const forensicsLevel = getForensicsLevel();
  if (forensicsSelect) {
    forensicsSelect.value = forensicsLevel;
    markInvalidStyles(); // Aktualisiere die Styles, falls erforderlich
  }
}
...
// Initialer Aufruf, um alles zu starten
document.addEventListener('DOMContentLoaded', () => {
  // ... (bestehender Code)
  createForensicNoteSection(); // Muss vor initCollapsibleCards aufgerufen werden
  initCollapsibleCards(); // Initialisiert die Toggle-Buttons
});
...
function createForensicNoteSection() {
  ...
  container.className = 'card-section'; // Verwendet den gleichen Stil wie andere Karten
  container.innerHTML = `
  ...
  // Fügt die neue Karte nach dem Compliance-Container ein.
  complianceContainer.insertAdjacentElement('afterend', container);
}

// ---------- 6) IT-Submit: validieren + speichern ----------
itForm?.addEventListener('submit', (e) => {
  e.preventDefault();

  // HTML5-Validierung und unsere Pflichtprüfung
...
// ---------- 7) Context-Form (falls vorhanden) ----------
complianceForm?.addEventListener('submit', (e) => {
  e.preventDefault();

  // NEU & KORRIGIERT: Logik zur Kopplung von B3S und BSIG.
  // Wird direkt vor dem Speichern ausgeführt, um Konsistenz zu gewährleisten.
  ...
  if (tacticInput) {
    updateActionsDisplay(tacticInput.value.trim());
    updateReportingDeadlines(); // NEU: Deadlines aktualisieren, wenn der Kontext gespeichert wird.
    // NEU: Forensik-Level nach dem Speichern der Compliance-Einstellungen neu bewerten und setzen.
    setForensicsLevelFromCompliance();
  }
});

// ---------- 8) MITRE-Form: nur rendern, kein Reload ----------
...
// NEU: Event Listener, um den vollen Taktik-Namen im Input anzuzeigen
tacticInput?.addEventListener('input', () => {
  ...
  if (option) {
    // Setze den vollen Text in das Input-Feld und löse die Aktualisierung aus
    tacticInput.value = option.textContent || tacticValue;
    updateActionsDisplay(tacticValue); // Hier wird der korrekte Code (value) übergeben
  } else if (tacticValue.includes(' - ')) {
    // Wenn der Benutzer tippt und der volle Name schon da ist, trotzdem aktualisieren
    const tacticId = tacticValue.split(' ')[0];
    updateActionsDisplay(tacticId);
  }
});

// ---------- 9) Anzeige-Logik (Helper) ----------
...
// ---------- 9) Anzeige-Logik ----------
function updateActionsDisplay(tacticId: string) { // Changed to accept tacticId
  if (!actionsDisplay) return;

  // Clear and re-create the structure including the copy button and feedback
  // KORREKTUR: Header in actions-display einfügen, Tabelle in actions-list-content
  ...
  if (!actionsDisplay.querySelector('.actions-header')) { // Header nur einmal einfügen
  ...
  // Ziel ist jetzt der tbody der Tabelle
  if (!tableBody) return;
  tableBody.innerHTML = ''; // Nur den Tabelleninhalt leeren

  // Add event listener for the copy button AFTER the content is rendered
  ...
  // Pflicht: alle IT-Felder gesetzt
  ...
  // Tactic ermitteln (+ Parent-Fallback für Untertaktiken)
  ...
  // Kopie für die Bearbeitung erstellen
  let current = [...actionIds];

  // Flag, ob ursprünglich PFM-Maßnahmen vorhanden waren (für die M009-Logik)
  const hasPfmMeasuresInitially = actionIds.some(id => id.startsWith('PFM'));

  // --- LOGIK FÜR FORENSIK-MAẞNAHMEN ---
  // NEU: Forensik-Level wird jetzt dynamisch aus den Compliance-Einstellungen ermittelt.
  // Der Wert aus dem Dropdown wird nur als Fallback verwendet, falls die Funktion nichts liefert.
  const forensicsKnowHow = getForensicsLevel() || forensicsSelect?.value;

  if (forensicsKnowHow === 'basicforensics') {
    current = current.filter(id => !id.startsWith('PFM')); // PFM ausfiltern
  } else if (forensicsKnowHow === 'noforensics') {
    current = current.filter(id => !id.startsWith('PFM') && !id.startsWith('BFM')); // Beide ausfiltern
  }

  // Reimage nur im Notfall - hier wird definiert bei welchen Angriffsarten ein Notfall vorliegt
  const isReimageException = false; // Temporär deaktiviert, um die Logik zu korrigieren.

  // Sonderregel A: Reimage NUR IN NOTFALL (local) → wenn M005 vorhanden, ersetze/erweitere wie gehabt
  // Diese Regel wird nicht angewendet, wenn die Taktik eine Ausnahme ist.
  if (current.includes('M005') && reimageSelect?.value === REIMAGE_ONLY_EMERGENCY) {
    ...
    // Reimage Client(s) entfernen und durch alternative Maßnahmen ersetzen.
  ...
  // NEU: Sonderregel für IR-Kapazitäten. Wenn nur für das Wichtigste, filtere gegen eine Whitelist.
  ...
  // KORREKTUR: Sicherstellen, dass M024 immer vor IM033 kommt.
  // Da M024 nur durch Logik hinzugefügt wird, fügen wir es hier explizit hinzu, falls IM033 vorhanden ist.
  const im033Index = current.indexOf('IM033');
  if (im033Index > -1) {
    const m024Index = current.indexOf('M024');
    if (m024Index === -1) { // Wenn M024 noch nicht da ist
      current.splice(im033Index, 0, 'M024'); // M024 direkt vor IM033 einfügen
    }
  }

  // Schrittweise Ausgabe starten
  // KORREKTUR: Phasen-Container übergeben
...
// Define prefixes for cleaning measure text
...
function renderGroupedMeasures(
    ...
    if (measures.length > 0) {
        ...
        headerTsCell.style.width = '185px'; // Feste Breite für die Timestamp-Zelle
        ...
        const headerTextSpan = document.createElement('span'); // Use a span to apply styles and allow text-decoration
        headerTextSpan.className = 'measure-text';
        // HIER WIRD DIE NUMMER EINGEFÜGT
        ...
        // Zelle 3 für Interaktion (leer für den Header)
        headerRow.insertCell();

        // Event Listener für den Header-Timestamp
        updateTimestampButtonIcon(headerTsButton, headerTsInput, headerTextSpan); // Initial icon state
        measureCounter++; // Zähler für die nächste Hauptmaßnahme erhöhen
        headerTsButton.addEventListener('click', () => {
            const now = new Date();
            const timestamp = `${pad(now.getDate())}.${pad(now.getMonth() + 1)}.${now.getFullYear()} ${pad(now.getHours())}:${pad(now.getMinutes())}:${pad(now.getSeconds())}`;
            
            if (headerTextSpan.style.textDecoration === 'line-through') {
                headerTsInput.value = timestamp;
                headerTextSpan.style.textDecoration = '';
            } else if (headerTsInput.value) {
                headerTsInput.value = '';
                headerTextSpan.style.textDecoration = 'line-through';
            } else {
                headerTsInput.value = timestamp;
            }
        ...
        measures.forEach(({ id, text }) => {
            ...
            subRow.setAttribute('data-measure-id', id); // KORREKTUR: data-measure-id für die Phasen-Balken hinzufügen
            renderedMeasuresSet.add(id); // Ensure it's marked as rendered

            // Zelle 1: Leer für Timestamp (da der Header den Timestamp hat)
            subRow.insertCell(); 

            // Zelle 2: Maßnahme
            const measureCell = subRow.insertCell();
            // Die Unterpunkte erhalten keine Nummer, sondern einen Bindestrich.
            ...
            subRow.insertCell(); // Empty cell for interaction alignment
        });
    }
...
function renderMeasuresStepwise(
  ...
  suspiciousAnswers: Set<string>, // Zustand für Antworten
  addM020IfNeeded: () => void // Callback zum Hinzufügen von M020
) {
  ...
  // Helper-Funktion, um M009 ('Engage external IR support') nur einmal hinzuzufügen.
  const addM009IfNeeded = () => {
   ...
   // NEUE REGEL (Teil 1): Wenn BFM-Maßnahmen vorhanden sind, aber kein Forensik-Wissen besteht, füge M009 hinzu.
  const hasBfmMeasuresInitially = list.some(id => id.startsWith('BFM'));
  if (hasBfmMeasuresInitially && forensicsSelect?.value === 'noforensics') {
    addM009IfNeeded();
  }

  // Helper-Funktion, um eine Maßnahme dynamisch zur Liste hinzuzufügen
  ...
  // Helper-Funktion, um die False-Positive-Bedingung zu prüfen und ggf. die Nachricht anzuzeigen.
  // Diese wird nun zentral aufgerufen, anstatt in jedem "no"-Button-Handler.
  ...
  // Helper-Funktion, um kontextabhängige Meldepflichten bei kritischen Ereignissen hinzuzufügen
  ...
  // um "M046 "Involve your IT Forensics Team" bei Meldepflichten ohne Forensik-Expertise hinzuzufügen
  const addForensicsTeamMeasureIfNeeded = (newlyAddedMeasures: string[], renderedMeasuresSet: Set<string>, targetTableBody: HTMLTableSectionElement) => {
    ...
    // KORREKTUR: Die Funktion wird jetzt für zwei Fälle genutzt:
    // 1. Nach Meldepflichten (gekennzeichnet durch M-Codes)
    // 2. Nach IM032 (gekennzeichnet durch den IM-Code)
    ...
    // Wenn einer der Trigger zutrifft und M046 noch nicht im Playbook ist:
  ...
  // Helper-Funktion für die dynamische Abfrage bei kritischen Maßnahmen
  ...
  // NEU: Logik für die "0." Maßnahme basierend auf Compliance-Anforderungen
  const compliance = loadCompliance();
  ...
  if (allSelectedContexts.length > 0) {
    ...
    if (allSelectedContexts.length === 1 && allSelectedContexts[0] === 'TKG') {
      // Fall 1: Nur TKG ist ausgewählt
      measureIdToAdd = 'M032';
    } else {
      // Fall 2: Mindestens eine Anforderung ist ausgewählt (und es ist nicht nur TKG)
      measureIdToAdd = 'M031';
    }
  ...
  const continueFrom = (startIdx: number) => {
    for (let i = startIdx; i < list.length; i++) {
      ...
      // NEU: M046 wird nie angezeigt, wenn das Forensik-Level 'noforensics' ist.
      // Dies gilt für M046, das direkt in der Taktik-Map steht (z.B. bei T1486).
      if (id === 'M046') {
        const forensicsLevel = getForensicsLevel();
        if (forensicsLevel === 'noforensics') {
      ...
      if (shouldAddBfm001 && !bfm001Added) {
        ...
        bfm001Added = true;
        // Wenn BFM001 wegen "not sure" hinzugefügt wurde, bevor M048/M043/M005 dran sind,
        // muss die Schleife normal weiterlaufen, ohne die aktuelle Maßnahme (id) zu überspringen.
        // Daher wird hier keine `continue` Anweisung benötigt.
        redrawBars();
      }
      ...
      row.setAttribute('data-measure-id', id); // NEU: data-attribute für die Zuordnung

      // --- Zelle 1: Timestamp ---
      const cell1 = row.insertCell();
      cell1.style.width = '185px'; // Korrektur: Feste Breite, um Überlappung zu verhindern
      const tsButton = document.createElement('button');
      tsButton.className = 'btn-secondary';
      tsButton.title = 'Set current time';
      tsButton.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>`;
      ...
      ]); // IDs, die blau und kursiv hervorgehoben werden sollen

      if (highlightIds.has(id)) {
        // NEU: Dynamischer Text für M046
        if (id === 'M046') {
          const forensicsLevel = getForensicsLevel();
      ...
      } else { // Changed from li.textContent = ... to li.innerHTML = ... for consistency
      ...
      // NEU: Wenn M001, M002 oder M003 ausgegeben wird, frage nach kritischen Diensten.
      const isCriticalAction = id === 'M001' || id === 'M002' || id === 'M003';
      if (isCriticalAction) {
        createCriticalityPrompt(id, cell3,
          () => { // onYes
            // Bei "yes" für M001, M002 oder M003, prüfe auf Meldepflichten.
            if (id === 'M001' || id === 'M002' || id === 'M003') {
              // HIER WIRD DIE NEUE MASSNAHME HINZUGEFÜGT
              ...
              // NEUE REGEL (Teil 2): Wenn kritische Dienste betroffen sind, füge M009 hinzu.
              addM009IfNeeded();
          ...
          () => { // onNo
            redrawBars(); // KORREKTUR: Balken auch hier neu zeichnen, um Konsistenz zu gewährleisten.
            continueFrom(i + 1);
          });
        return; // Stop further rendering until user answers
      }

      // NEU: Wenn M024 ausgegeben wurde, füge eine Leerzeile für besseren Abstand hinzu.
      if (id === 'M024') {
      }

      // --- Stop-Case #1: M017 → Criticality-Abfrage + ggf. M009 (bei GDPR + High personal)
      if (id === 'M017') {
        ...
        contBtn?.addEventListener('click', () => {
            ...
            // statt nur regulatory -> regulatory + voluntary zusammenführen
            ...
            // GDPR-Erkennung: nimm EU-GDPR aus regs, oder – falls vorhanden – deine Helper-Funktion
            ...
            // KORREKTUR: Prompt entfernen und die Antwort in die Zelle schreiben.
            ...
            // Danach die zuvor gestoppte Ausgabe fortsetzen
            continueFrom(i + 1);
          });
      ...
      // NEU: Spezifische Abfrage für IM012
      if (id === 'IM012') {
        const prompt = document.createElement('div');
        ...
        noBtn?.addEventListener('click', () => {
          ...
          // The process should continue normally, without jumping to a special recovery path.
          continueFrom(i + 1);
          redrawBars();
        });
        return; // Stop further rendering until user answers
      ...
      // --- Stop-Case #2: ausgewählte Investigative Measures (IMxxx)
      ...
      if (measuresWithSuspiciousPrompt.has(id)) {
        ...
        noBtn?.addEventListener('click', () => {
          ...
          // NEU: "no"-Antwort für relevante IMs speichern
          // KORREKTUR: IM033 zur Liste der zu verfolgenden "no"-Antworten hinzugefügt.
          ...
          // NEU: Sonderregel für IM011 und IM032
          ...
          // Prüfe, ob die FP-Bedingung jetzt erfüllt ist.
          if (checkAndShowFalsePositive(answeredNoForCriticalChecks)) {
            redrawBars();
            return; // Abarbeitung stoppen
          }
          // KORRIGIERT: Logik für IM041 bei "no" (Backup ist OK)
          if (id === 'IM041') {
          ...
          continueFrom(i + 1); // Setze die Abarbeitung für andere IMs fort.
        });
        ...
        yesBtn?.addEventListener('click', () => {
          ...
          // NEU: Wenn IM032 mit "yes" beantwortet wird, füge M039 hinzu und prüfe, ob M046 hinzugefügt werden soll.
          if (id === 'IM032') {
            const measuresToAdd = ['M039']; // M046 wird separat behandelt

            // Entferne die Maßnahmen aus späteren Teilen der Liste, um Duplikate zu verhindern.
            list = list.filter((measureId, index) => {
              return !measuresToAdd.includes(measureId) || index <= i;
            });

            // Füge M039 hinzu, wenn es noch nicht gerendert wurde.
            const newMeasure = measuresToAdd.find(m => !renderedMeasures.has(m));
            if (newMeasure) {
              list.splice(i + 1, 0, newMeasure);
            }
            // KORREKTUR: Rufe die zentrale Funktion mit dem korrekten Trigger 'IM032' auf.
            addForensicsTeamMeasureIfNeeded(['IM032'], renderedMeasures, targetTableBody);
          }

          // NEU & KORRIGIERT: Logik für IM041 bei "yes/not sure" (Backup ist NICHT OK)
          if (id === 'IM041') {
          ...
          continueFrom(i + 1); // Setze die Abarbeitung der Liste fort.
        });
        ...
        notSureBtn?.addEventListener('click', () => {
          ...
          // NEU: Wenn IM032 mit "not sure" beantwortet wird, behandle es wie "yes".
          if (id === 'IM032') {
            const measuresToAdd = ['M039']; // M046 wird separat behandelt
          ...
          // NEU: Wenn bei IM041 "not sure" gewählt wird, behandle es wie "yes".
          if (id === 'IM041') {
            // Ersetze M043 (Restore) durch M048 (Reimage) in der verbleibenden Liste.
            const m043Index = list.indexOf('M043');
            if (m043Index > -1) {
    ...
    // KORREKTUR: Die Balken werden jetzt innerhalb der Schleife nach jeder Maßnahme neu gezeichnet.
  };
  ...
  // KORREKTUR: Die Funktion wird jetzt außerhalb von `continueFrom` deklariert,
  // damit sie von den Prompt-Callbacks aufgerufen werden kann.
...
/**
 * Helper-Funktion zum Erstellen und Binden von Timestamp-Buttons.
 * @param cell Die Tabellenzelle, zu der die Steuerelemente hinzugefügt werden sollen.
...
// ---------- NEU: Phasen-Mapping für die vertikalen Balken ----------
const measureToPhaseMap: Record<string, string> = {
  ...
  'M020': 'Recover', // M020 (update security patches) zu Recover hinzugefügt
...
function rgbToHex(rgb: string): string {
    ...
    if (!result) return rgb; // Fallback, falls es kein RGB ist
    return "#" + [1, 2, 3].map(i => parseInt(result[i]).toString(16).padStart(2, '0')).join('');
}

/**
 * KORRIGIERTE VERSION 3.0: Erstellt eine saubere HTML-Repräsentation der Tabelle mit Inline-Stilen
 * und kopiert diese in die Zwischenablage. Dieser Ansatz ist robuster als das Klonen des DOM.
...
function copyTableWithStyles(tableElement: HTMLTableElement | null, feedbackElementId: string) {
  ...
  tableElement.querySelectorAll('tbody tr').forEach(row => {
    ...
    row.querySelectorAll('td').forEach((cell, cellIndex) => {
      ...
      if (cellIndex === 0) { // Timestamp-Zelle
        ...
        cellStyle += ' white-space: nowrap;'; // Verhindert Umbruch bei Timestamps
        ...
        if (textSpan) {
          ...
          // Priorisiere die Farbe aus dem inneren <i>-Tag, falls vorhanden (für Hervorhebungen)
          if (innerI) {
          ...
          // Text-Dekoration vom textSpan übernehmen (durchgestrichen)
          ...
          // Word benötigt oft Stile auf Block-Elementen (<p>) und auf den Zellen selbst.
          // Wir wenden die Stile redundant an, um die Kompatibilität zu erhöhen.
          ...
          // Das <p>-Tag umschließt den Inhalt für bessere Word-Kompatibilität.
          // Der innere HTML-Inhalt (z.B. <i>-Tags) wird beibehalten.
          newCell.innerHTML = `<p style="${pStyle}">${textSpan.innerHTML}</p>`;
        } else {
          // Fallback für Zellen ohne .measure-text, auch in <p> umschließen
  ...
  tempDiv.style.left = '-9999px'; // Außerhalb des sichtbaren Bereichs
...
// ===== Deadlines for potential reporting obligations =====
function ensureDeadlineContainer(): HTMLDivElement | null {
  ...
  if (copyBtn) {
    copyBtn.addEventListener('click', () => {
      const contentDiv = container?.querySelector('#reporting-deadlines') as HTMLTableElement | null;
...
/**
 * Initialisiert die "Alert Start Time"-Funktionalität von Grund auf neu.
 *   Setzt die aktuelle Zeit als Standard.
 * - Ermöglicht dem Benutzer, die Zeit über einen nativen Picker zu ändern.
...
function initAlertTimer() {
  ...
  // Hilfsfunktion zum zweistelligen Formatieren von Zahlen
  const pad = (n: number) => String(n).padStart(2, '0');

  // Formatiert ein Datum für das datetime-local Input (YYYY-MM-DDTHH:mm:ss)
  ...
  // Formatiert ein Datum für die Anzeige (tt.mm.jjjj hh:mm:ss)
  ...
  // Startet oder aktualisiert die Stoppuhr
  ...
  // Aktualisiert alle Anzeigen und Berechnungen basierend auf dem Datum
  function updateAll(date: Date) {
    functionalInput.value = toLocalISOString(date);
    displayInput.value = toGermanDateTimeString(date);
    startStopwatch(date);
    updateReportingDeadlines(); // Diese Funktion existiert bereits und wird hier aufgerufen
  }

  // Event-Listener für das sichtbare Anzeigefeld
  ...
  // Event-Listener für das funktionale (versteckte) Datumsfeld
  ...
  // Initialisierung: Setze die aktuelle Zeit und starte alles.
  updateAll(new Date());
}
